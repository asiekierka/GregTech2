...
public class PlasmaFuelsHandler
extends GT_RecipeHandler {
    ...
    public void loadTransferRects() {
        try {
            ...
            ArrayList<Class<GT_GUIContainer_PlasmaGenerator>> guis = new ArrayList<Class<GT_GUIContainer_PlasmaGenerator>>();
            ArrayList<TemplateRecipeHandler.RecipeTransferRect> transferRects2 = new ArrayList<TemplateRecipeHandler.RecipeTransferRect>();
            guis.add(GT_GUIContainer_PlasmaGenerator.class);
    ...
    public String getRecipeName() {
        return "Plasma Generator";
    }

    @Override
    public String getRecipeId() {
        return "gregtech.PlasmaFuels";
    }
    ...
    public GT_RecipeHandler.CachedGT_Recipe getRecipe(GT_Recipe irecipe) {
        return new CachedPlasmaFuels(irecipe);
    }

    public void drawExtras(GuiContainerManager gui, int recipe) {
        CachedPlasmaFuels t = (CachedPlasmaFuels)((Object)this.arecipes.get(recipe));
        gui.drawText(30, 80, "EU: " + this.toNumber(t.mStartEU * 1000) + "EU", -16777216, false);
    }

    public class CachedPlasmaFuels
    extends GT_RecipeHandler.CachedGT_Recipe {
        public int mStartEU;

        public CachedPlasmaFuels(GT_Recipe aRecipe) {
            int xoffset = 4;
            int yoffset = 4;
