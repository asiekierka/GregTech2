...
public class VacuumFreezerRecipeHandler
extends GT_RecipeHandler {
    @Override
    public void loadTransferRects() {
        try {
            this.transferRects.add(new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(72, 22, 24, 15), this.getRecipeId(), new Object[0]));
            ArrayList<Class<GT_GUIContainer_VacuumFreezer>> guis = new ArrayList<Class<GT_GUIContainer_VacuumFreezer>>();
    ...
    public String getGuiTexture() {
        return "/gregtechmod/textures/gui/NEIVacuumFreezer.png";
    }
    ...
    public void drawExtras(GuiContainerManager gui, int recipe) {
        Integer time = ((CachedVacuumFreezerRecipe)((Object)this.arecipes.get((int)recipe))).mDuration;
        gui.drawText(30, 80, "EU: " + this.toNumber(time * ((CachedVacuumFreezerRecipe)((Object)this.arecipes.get((int)recipe))).mEUt), -16777216, false);
        gui.drawText(30, 90, "Time: " + this.toNumber(time / 20) + " secs", -16777216, false);
        gui.drawText(30, 100, "MaxEnergy: " + this.toNumber(((CachedVacuumFreezerRecipe)((Object)this.arecipes.get((int)recipe))).mEUt) + " EU/t", -16777216, false);
    }

    public class CachedVacuumFreezerRecipe
    extends GT_RecipeHandler.CachedGT_Recipe {
        ...
        public CachedVacuumFreezerRecipe(GT_Recipe aRecipe) {
            ...
            if (aRecipe.mInput1 != null) {
                this.resources.add(new PositionedStack((Object)aRecipe.mInput1, 54 - xoffset, 25 - yoffset));
            }
            this.products = new ArrayList();
            if (aRecipe.mOutput1 != null) {
                this.products.add(new PositionedStack((Object)aRecipe.mOutput1, 106 - xoffset, 25 - yoffset));
            }
