...
public class WiremillRecipeHandler
extends GT_RecipeHandler {
    ...
    public void loadTransferRects() {
        try {
            ...
            ArrayList<Class<GT_GUIContainer_BasicMachine_Wiremill>> guis = new ArrayList<Class<GT_GUIContainer_BasicMachine_Wiremill>>();
    ...
    public String getGuiTexture() {
        return "/gregtechmod/textures/gui/NEIWiremill.png";
    }
    ...
    public void drawExtras(GuiContainerManager gui, int recipe) {
        Integer time = ((CachedWiremillRecipe)((Object)this.arecipes.get((int)recipe))).mDuration;
        gui.drawText(30, 80, "EU: " + this.toNumber(time * ((CachedWiremillRecipe)((Object)this.arecipes.get((int)recipe))).mEUt), -16777216, false);
        gui.drawText(30, 90, "Time: " + this.toNumber(time / 20) + " secs", -16777216, false);
        gui.drawText(30, 100, "MaxEnergy: " + this.toNumber(((CachedWiremillRecipe)((Object)this.arecipes.get((int)recipe))).mEUt) + " EU/t", -16777216, false);
    }

    public class CachedWiremillRecipe
