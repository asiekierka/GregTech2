...
extends GT_RecipeHandler {
    ...
    public void loadTransferRects() {
        try {
            ...
            ArrayList<Class<GT_GUIContainer_ThermalGenerator>> guis = new ArrayList<Class<GT_GUIContainer_ThermalGenerator>>();
    ...
    public void drawExtras(GuiContainerManager gui, int recipe) {
        CachedHotFuels t = (CachedHotFuels)((Object)this.arecipes.get(recipe));
        gui.drawText(30, 80, "EU: " + this.toNumber(t.mStartEU * 1000) + "EU", -16777216, false);
    }

    public class CachedHotFuels
