...
public class DenseLiquidFuelsHandler
extends GT_RecipeHandler {
    ...
    public void loadTransferRects() {
        try {
            ...
            ArrayList<Class<GT_GUIContainer_SemifluidGenerator>> guis = new ArrayList<Class<GT_GUIContainer_SemifluidGenerator>>();
            ArrayList<TemplateRecipeHandler.RecipeTransferRect> transferRects2 = new ArrayList<TemplateRecipeHandler.RecipeTransferRect>();
            guis.add(GT_GUIContainer_SemifluidGenerator.class);
    ...
    public String getRecipeId() {
        return "gregtech.DenseLiquidFuels";
    }
    ...
    public GT_RecipeHandler.CachedGT_Recipe getRecipe(GT_Recipe irecipe) {
        return new CachedDenseLiquidFuels(irecipe);
    }

    public void drawExtras(GuiContainerManager gui, int recipe) {
        CachedDenseLiquidFuels t = (CachedDenseLiquidFuels)((Object)this.arecipes.get(recipe));
        gui.drawText(30, 80, "EU: " + this.toNumber(t.mStartEU * 1000) + "EU", -16777216, false);
    }

    public class CachedDenseLiquidFuels
    extends GT_RecipeHandler.CachedGT_Recipe {
        public int mStartEU;

        public CachedDenseLiquidFuels(GT_Recipe aRecipe) {
            int xoffset = 4;
            int yoffset = 4;
