...
public class ImplosionRecipeHandler
extends GT_RecipeHandler {
    ...
    public void loadTransferRects() {
        try {
            ...
            ArrayList<Class<GT_GUIContainer_ImplosionCompressor>> guis = new ArrayList<Class<GT_GUIContainer_ImplosionCompressor>>();
    ...
    public String getGuiTexture() {
        return "/gregtechmod/textures/gui/NEIImplosion.png";
    }
    ...
    public void drawExtras(GuiContainerManager gui, int recipe) {
        Integer time = ((CachedImplosionRecipe)((Object)this.arecipes.get((int)recipe))).mDuration;
        gui.drawText(30, 80, "EU: " + this.toNumber(time * ((CachedImplosionRecipe)((Object)this.arecipes.get((int)recipe))).mEUt), -16777216, false);
        gui.drawText(30, 90, "Time: " + this.toNumber(time / 20) + " secs", -16777216, false);
        gui.drawText(30, 100, "MaxEnergy: " + this.toNumber(((CachedImplosionRecipe)((Object)this.arecipes.get((int)recipe))).mEUt) + " EU/t", -16777216, false);
    }

    public class CachedImplosionRecipe
