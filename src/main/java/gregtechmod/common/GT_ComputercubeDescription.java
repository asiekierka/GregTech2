	...
	public static void addStandardDescriptions() {
		new GT_ComputercubeDescription(
				new String[] {
			    		...
			    		"To charge it just apply a",
			    		"Redstone Signal.",
			    		"It emits 1 Million EU/p.",
			    		"",
				...
				new ItemStack[] {
						null,
						null,
						GT_MetaItem_Component.instance.getStack(20, 1),
		...
		new GT_ComputercubeDescription(
				...
				new ItemStack[] {
						...
						null,
						null,
						new ItemStack(GT_Mod.instance.mBlocks[1], 1,25),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				...
				new ItemStack[] {
						...
						new ItemStack(GT_Mod.instance.mBlocks[0], 1,14),
						new ItemStack(GT_Mod.instance.mBlocks[0], 1,13),
						new ItemStack(GT_Mod.instance.mBlocks[1], 1,28),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				...
				new ItemStack[] {
						...
						null,
						null,
						new ItemStack(GT_Mod.instance.mBlocks[1], 1,29),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				...
				new ItemStack[] {
						...
						new ItemStack(GT_Mod.instance.mBlocks[1], 1,32),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				...
				new ItemStack[] {
						...
						new ItemStack(GT_Mod.instance.mBlocks[1], 1,31),
						null,
						null,
						null,
						null,
