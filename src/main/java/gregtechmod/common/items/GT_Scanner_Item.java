...
public class GT_Scanner_Item
extends GT_Generic_Item
implements IElectricItem {
    public GT_Scanner_Item(int aID) {
        super(aID);
    ...
    public void getSubItems(int var1, CreativeTabs var2, List var3) {
        ...
        ElectricItem.charge((ItemStack)tCharged, (int)this.getMaxCharge(), (int)Integer.MAX_VALUE, (boolean)true, (boolean)false);
        var3.add(tCharged);
    }
    ...
    public boolean onItemUseFirst(ItemStack aStack, EntityPlayer aPlayer, World aWorld, int aX, int aY, int aZ, int aSide, float var8, float var9, float var10) {
        if (aPlayer instanceof EntityPlayerMP && ElectricItem.canUse((ItemStack)aStack, (int)1000)) {
            ArrayList temp;
            ElectricItem.use((ItemStack)aStack, (int)1000, (EntityPlayer)aPlayer);
            ...
            if (tTileEntity != null) {
                ...
                if (tTileEntity instanceof TECrop) {
                    if (((TECrop)tTileEntity).scanLevel < 4 && ElectricItem.canUse((ItemStack)aStack, (int)24000)) {
                        ElectricItem.use((ItemStack)aStack, (int)24000, (EntityPlayer)aPlayer);
                        ((TECrop)tTileEntity).scanLevel = (byte)4;
                    }
                    if (((TECrop)tTileEntity).scanLevel >= 4) {
            ...
            if (tBlock instanceof IDebugableBlock && (temp = ((IDebugableBlock)tBlock).getDebugInfo(aPlayer, aX, aY, aZ, 1)) != null) {
                tList.addAll(temp);
            }
