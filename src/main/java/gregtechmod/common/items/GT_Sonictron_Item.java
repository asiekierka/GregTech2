...
public class GT_Sonictron_Item extends GT_Generic_Item implements IIgnoreRightclickOnMachine, IPlayerTickingItem {
    ...
    public boolean onItemUse(ItemStack aStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10) {
		if (!par3World.isRemote && par3World.getBlockId(par4, par5, par6) == GT_Mod.instance.mBlocks[1].blockID && par3World.getBlockMetadata(par4, par5, par6) == 6) {
