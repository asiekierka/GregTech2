...
public class GT_Renderer extends RenderPlayer {
    ...
    public void renderSpecials(EntityPlayer par1EntityPlayer, float par2) {
        ...
        /**
         * RichardG, its time to strike back for all the people you have trolled.
         * If you read this, you have decompiled my Addon to find out who removed your Cape.
         * You did that to Tahg, so I thought it would be a good way, to do that to you too.
         */
		if (par1EntityPlayer.username.equals("RichardG867")) {
        ...
        try {
            if (GT_Mod.instance.mShowCapes) {
            	if (GT_Mod.sAdminNames.contains(par1EntityPlayer.username))
	    			tLoaded = loadDownloadableImageTexture("", "/gregtechmodcapes/AdminCape.png");
	    		if (GT_Mod.sPremiumNames.contains(par1EntityPlayer.username))
	    			tLoaded = loadDownloadableImageTexture("", "/gregtechmodcapes/PremiumCape.png");
		    	if (GT_Mod.mBrainTechCapeList.contains(par1EntityPlayer.username))
		    		tLoaded = loadDownloadableImageTexture("https://dl.dropbox.com/u/88825306/BrainTechCape.png", "/gregtechmod/textures/BrainTechCape.png");
	    		if (GT_Mod.mGregTechCapeList.contains(par1EntityPlayer.username))
		    		tLoaded = loadDownloadableImageTexture("https://dl.dropbox.com/u/88825306/GregTechCape.png", "/gregtechmod/textures/GregTechCape.png");
            }
            /**
             * One cant just turn the Main Capes OFF.
             */
    		if (par1EntityPlayer.username.equals("Mr_Brain"))
	    		tLoaded = loadDownloadableImageTexture("https://dl.dropbox.com/u/88825306/MrBrainCape.png", "/gregtechmod/textures/MrBrainCape.png");
    		if (par1EntityPlayer.username.equals("GregoriusT"))
	    		tLoaded = loadDownloadableImageTexture("https://dl.dropbox.com/u/88825306/GregoriusCape.png", "/gregtechmod/textures/GregoriusCape.png");
	    } catch (Throwable e) {
