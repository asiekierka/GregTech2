...
public class GT_GUIContainer_Quantumtank extends GT_GUIContainerMetaTile_Machine {
    ...
    public GT_GUIContainer_Quantumtank(InventoryPlayer aInventoryPlayer, BaseMetaTileEntity aTileEntity, int aID) {
        super(new GT_Container_Quantumtank(aInventoryPlayer, aTileEntity, aID), aTileEntity, aID);
    }
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        if (mTileEntity != null) {
        	...
        	fontRenderer.drawString(toNumber(((GT_Container_Quantumtank)mContainer).mContent), 10, 30, 16448255);
        }
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        int texture = mc.renderEngine.getTexture("/gregtechmod/textures/gui/Quantumtank.png");
