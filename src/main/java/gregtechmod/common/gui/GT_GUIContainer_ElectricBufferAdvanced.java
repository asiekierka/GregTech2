...
public class GT_GUIContainer_ElectricBufferAdvanced
extends GT_GUIContainerMetaTile_Machine {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        this.fontRenderer.drawString("" + ((GT_Container_ElectricBufferAdvanced)this.mContainer).mTargetSlot, 100, 65, 0xFAFAFF);
    }

    @Override
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        int texture = this.mc.renderEngine.getTexture("/gregtechmod/textures/gui/ElectricBufferAdvanced.png");
