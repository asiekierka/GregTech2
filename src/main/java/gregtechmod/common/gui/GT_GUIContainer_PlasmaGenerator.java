...
public class GT_GUIContainer_PlasmaGenerator
extends GT_GUIContainerMetaTile_Machine {
    public GT_GUIContainer_PlasmaGenerator(InventoryPlayer aInventoryPlayer, BaseMetaTileEntity aTileEntity, int aID) {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        this.fontRenderer.drawString("Plasma Generator", 8, 6, 0x404040);
        if (this.mTileEntity != null) {
            this.fontRenderer.drawString("Plasma Amount", 10, 20, 0xFAFAFF);
