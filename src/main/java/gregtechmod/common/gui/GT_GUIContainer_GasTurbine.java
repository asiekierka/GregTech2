...
public class GT_GUIContainer_GasTurbine extends GT_GUIContainerMetaTile_Machine {
    ...
    public GT_GUIContainer_GasTurbine(InventoryPlayer aInventoryPlayer, BaseMetaTileEntity aTileEntity, int aID) {
        super(new GT_Container_GasTurbine(aInventoryPlayer, aTileEntity, aID), aTileEntity, aID);
    }
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        if (mTileEntity != null) {
        	...
        	fontRenderer.drawString(toNumber(((GT_Container_GasTurbine)mContainer).mContent), 10, 30, 16448255);
        }
    }
