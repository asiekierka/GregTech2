...
public class GT_GUIContainer_FusionExtractor
extends GT_GUIContainerMetaTile_Machine {
    public GT_GUIContainer_FusionExtractor(InventoryPlayer aInventoryPlayer, BaseMetaTileEntity aTileEntity, int aID) {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        this.fontRenderer.drawString("Material Extractor", 8, 6, 0x404040);
