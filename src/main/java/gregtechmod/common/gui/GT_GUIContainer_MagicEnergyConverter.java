...
public class GT_GUIContainer_MagicEnergyConverter
extends GT_GUIContainerMetaTile_Machine {
    public GT_GUIContainer_MagicEnergyConverter(InventoryPlayer aInventoryPlayer, BaseMetaTileEntity aTileEntity, int aID) {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        this.fontRenderer.drawString("Magic Energy Converter", 8, 6, 0x404040);
