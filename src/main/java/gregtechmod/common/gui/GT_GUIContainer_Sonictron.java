...
public class GT_GUIContainer_Sonictron
extends GT_GUIContainerMetaID_Machine {
    public GT_GUIContainer_Sonictron(InventoryPlayer aInventoryPlayer, GT_TileEntity_Sonictron aTileEntity, int aID) {
        super(new GT_Container_Sonictron(aInventoryPlayer, aTileEntity, aID), (GT_TileEntityMetaID_Machine)aTileEntity, aID);
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        int texture = this.mc.renderEngine.getTexture("/gregtechmod/textures/gui/Sonictron.png");
