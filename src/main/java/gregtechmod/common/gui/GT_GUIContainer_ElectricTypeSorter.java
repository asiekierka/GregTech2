...
public class GT_GUIContainer_ElectricTypeSorter
extends GT_GUIContainerMetaTile_Machine {
    public GT_GUIContainer_ElectricTypeSorter(InventoryPlayer aInventoryPlayer, BaseMetaTileEntity aTileEntity, int aID) {
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        int texture = this.mc.renderEngine.getTexture("/gregtechmod/textures/gui/ElectricTypeSorter.png");
        ...
        if (this.mContainer != null) {
            this.drawTexturedModalRect(x + 70, y + 22, ((GT_Container_ElectricTypeSorter)this.mContainer).mMode * 18, 166, 18, 18);
        }
    }
}
