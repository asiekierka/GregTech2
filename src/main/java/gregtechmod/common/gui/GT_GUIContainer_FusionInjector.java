...
public class GT_GUIContainer_FusionInjector
extends GT_GUIContainerMetaTile_Machine {
    public GT_GUIContainer_FusionInjector(InventoryPlayer aInventoryPlayer, BaseMetaTileEntity aTileEntity, int aID) {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        this.fontRenderer.drawString("Material Injector", 8, 6, 0x404040);
