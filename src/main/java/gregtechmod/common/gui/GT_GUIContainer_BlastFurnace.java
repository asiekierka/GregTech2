...
public class GT_GUIContainer_BlastFurnace
extends GT_GUIContainerMetaTile_Machine {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        this.fontRenderer.drawString("Industrial Blast Furnace", 8, 4, 0x404040);
        if (((GT_Container_BlastFurnace)this.mContainer).mMachine) {
            this.fontRenderer.drawString("Heat Capacity: " + ((GT_Container_BlastFurnace)this.mContainer).mHeatCapacity + " K", 8, this.ySize - 103, 0x404040);
        } else {
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        int texture = this.mc.renderEngine.getTexture("/gregtechmod/textures/gui/Blast.png");
        ...
        if (this.mContainer != null) {
            int tScale = ((GT_Container_BlastFurnace)this.mContainer).mProgressScale;
