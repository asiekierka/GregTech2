...
public class GT_Container_ThermalGenerator extends GT_ContainerMetaTile_Machine {

	public GT_Container_ThermalGenerator(InventoryPlayer aInventoryPlayer, BaseMetaTileEntity aTileEntity, int aID) {
    ...
    public void updateCraftingResults() {
    	...
    	if (((GT_MetaTileEntity_ThermalGenerator)mTileEntity.mMetaTileEntity).mLiquid != null)
    		mContent = ((GT_MetaTileEntity_ThermalGenerator)mTileEntity.mMetaTileEntity).mLiquid.amount;
    	else
    		mContent = 0;
