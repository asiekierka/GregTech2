...
public class GT_Container_ChemicalReactor
extends GT_ContainerMetaTile_Machine {
    public int mProgress;
    public int mMaxProgress;
    public int mProgressScale;

    public GT_Container_ChemicalReactor(InventoryPlayer aInventoryPlayer, BaseMetaTileEntity aTileEntity, int aID) {
        super(aInventoryPlayer, aTileEntity, aID);
    }

    @Override
    public void addSlots(InventoryPlayer aInventoryPlayer) {
        this.addSlotToContainer(new Slot((IInventory)this.mTileEntity, 0, 70, 16));
        this.addSlotToContainer(new Slot((IInventory)this.mTileEntity, 1, 90, 16));
        this.addSlotToContainer(new GT_Slot_Output((IInventory)this.mTileEntity, 2, 80, 46));
    }
    ...
    public void detectAndSendChanges() {
        ...
        this.mProgress = ((GT_MetaTileEntity_ChemicalReactor)this.mTileEntity.mMetaTileEntity).getProgresstime();
        this.mMaxProgress = ((GT_MetaTileEntity_ChemicalReactor)this.mTileEntity.mMetaTileEntity).maxProgresstime();
