...
public class GT_Container_GasTurbine extends GT_ContainerMetaTile_Machine {

	public GT_Container_GasTurbine(InventoryPlayer aInventoryPlayer, BaseMetaTileEntity aTileEntity, int aID) {
    ...
    public void updateCraftingResults() {
    	...
    	if (((GT_MetaTileEntity_GasTurbine)mTileEntity.mMetaTileEntity).mLiquid != null)
    		mContent = ((GT_MetaTileEntity_GasTurbine)mTileEntity.mMetaTileEntity).mLiquid.amount;
    	else
    		mContent = 0;
