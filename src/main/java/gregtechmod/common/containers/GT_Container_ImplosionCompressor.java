...
public class GT_Container_ImplosionCompressor extends GT_ContainerMetaTile_Machine {
    ...
    public void updateCraftingResults() {
    	...
    	mMachine = ((GT_MetaTileEntity_ImplosionCompressor)mTileEntity.mMetaTileEntity).mMachine;
    	mProgress = ((GT_MetaTileEntity_ImplosionCompressor)mTileEntity.mMetaTileEntity).getProgresstime();
    	mMaxProgress = ((GT_MetaTileEntity_ImplosionCompressor)mTileEntity.mMetaTileEntity).maxProgresstime();
