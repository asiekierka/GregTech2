...
public class GT_Container_ComputerCube extends GT_ContainerMetaID_Machine {
    ...
    public ItemStack slotClick(int aSlotIndex, int aMouseclick, int aShifthold, EntityPlayer aPlayer) {
	    ...
	    if (tSlot != null) {
	    	if (aSlotIndex == 0) {
	    		((GT_TileEntity_ComputerCube)mTileEntity).switchMode();
	    		aPlayer.openGui(GT_Mod.instance, GT_BlockMetaID_Machine.getComputerCubeGUIID(mTileEntity), mTileEntity.worldObj, mTileEntity.xCoord, mTileEntity.yCoord, mTileEntity.zCoord);
	    	} else {
		    			...
		    			if (aShifthold == 1) {
		    		    	...
		    		    	if (tStack == null) {
		    		    		...
		    		    		for (int i = 1; i < GT_TileEntity_ComputerCube.sReactorList.size(); i++) {
			    		    		if (GT_TileEntity_ComputerCube.sReactorList.get(i-1).shiftedIndex == tStack.itemID) {
    ...
    public void updateCraftingResults() {
        ...
        while (var2.hasNext()) {
            ...
            var1.sendProgressBarUpdate(this, 11, mEUOut);
            var1.sendProgressBarUpdate(this, 12, mHeat & 65535);
            var1.sendProgressBarUpdate(this, 13, mMaxHeat & 65535);
            var1.sendProgressBarUpdate(this, 14, mHEM);
            var1.sendProgressBarUpdate(this, 15, mExplosionStrength);
            var1.sendProgressBarUpdate(this, 16, mHeat >>> 16);
            var1.sendProgressBarUpdate(this, 17, mMaxHeat >>> 16);
            var1.sendProgressBarUpdate(this, 18, mEU & 65535);
            var1.sendProgressBarUpdate(this, 19, mEU >>> 16);
            var1.sendProgressBarUpdate(this, 20, mProgress);
        }
    }
    ...
    public void updateProgressBar(int par1, int par2) {
    	...
    	switch (par1) {
    	case 11: mEUOut = par2; break;
    	case 12: mHeat = mHeat & -65536 | par2; break;
    	case 13: mMaxHeat = mMaxHeat & -65536 | par2; break;
    	case 14: mHEM = par2; break;
    	case 15: mExplosionStrength = par2; break;
    	case 16: mHeat = mHeat &  65535 | par2 << 16; break;
    	case 17: mMaxHeat = mMaxHeat &  65535 | par2 << 16; break;
    	case 18: mEU = mEU & -65536 | par2;
    	case 19: mEU = mEU &  65535 | par2 << 16; break;
    	case 20: mProgress = par2; break;
    	}
    }
