...
public class GT_Container_SemifluidGenerator extends GT_ContainerMetaTile_Machine {

	public GT_Container_SemifluidGenerator(InventoryPlayer aInventoryPlayer, BaseMetaTileEntity aTileEntity, int aID) {
    ...
    public void updateCraftingResults() {
    	...
    	if (((GT_MetaTileEntity_SemifluidGenerator)mTileEntity.mMetaTileEntity).mLiquid != null)
    		mContent = ((GT_MetaTileEntity_SemifluidGenerator)mTileEntity.mMetaTileEntity).mLiquid.amount;
    	else
    		mContent = 0;
