...
public class GT_Container_DieselGenerator extends GT_ContainerMetaTile_Machine {

	public GT_Container_DieselGenerator(InventoryPlayer aInventoryPlayer, BaseMetaTileEntity aTileEntity, int aID) {
    ...
    public void updateCraftingResults() {
    	...
    	if (((GT_MetaTileEntity_DieselGenerator)mTileEntity.mMetaTileEntity).mLiquid != null)
    		mContent = ((GT_MetaTileEntity_DieselGenerator)mTileEntity.mMetaTileEntity).mLiquid.amount;
    	else
    		mContent = 0;
