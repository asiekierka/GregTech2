...
public class GT_Container_ElectricBufferSmall
extends GT_ContainerMetaTile_Machine {
    public GT_Container_ElectricBufferSmall(InventoryPlayer aInventoryPlayer, BaseMetaTileEntity aTileEntity, int aID) {
