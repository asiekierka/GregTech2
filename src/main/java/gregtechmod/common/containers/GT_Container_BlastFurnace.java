...
public class GT_Container_BlastFurnace extends GT_ContainerMetaTile_Machine {
    ...
    public void updateCraftingResults() {
    	...
    	mMachine = ((GT_MetaTileEntity_BlastFurnace)mTileEntity.mMetaTileEntity).mMachine;
    	mProgress = ((GT_MetaTileEntity_BlastFurnace)mTileEntity.mMetaTileEntity).getProgresstime();
    	mMaxProgress = ((GT_MetaTileEntity_BlastFurnace)mTileEntity.mMetaTileEntity).maxProgresstime();
    	mProgressScale = Math.max(0, Math.min(20, (mProgress>0?1:0) + (mProgress * 20) / (mMaxProgress<1?1:mMaxProgress)));
    	mHeatCapacity = ((GT_MetaTileEntity_BlastFurnace)mTileEntity.mMetaTileEntity).mHeatCapacity;
        ...
        while (var2.hasNext()) {
            ...
            var1.sendProgressBarUpdate(this, 14, mHeatCapacity);
        }
    }
    ...
    public void updateProgressBar(int par1, int par2) {
    	...
    	case 14: mHeatCapacity = par2; break;
    	}
    }
