...
public class GT_Container_BlastFurnace
extends GT_ContainerMetaTile_Machine {
    ...
    public GT_Container_BlastFurnace(InventoryPlayer aInventoryPlayer, BaseMetaTileEntity aTileEntity, int aID) {
    ...
    public void detectAndSendChanges() {
        ...
        this.mMachine = ((GT_MetaTileEntity_BlastFurnace)this.mTileEntity.mMetaTileEntity).mMachine;
        this.mProgress = ((GT_MetaTileEntity_BlastFurnace)this.mTileEntity.mMetaTileEntity).getProgresstime();
        this.mMaxProgress = ((GT_MetaTileEntity_BlastFurnace)this.mTileEntity.mMetaTileEntity).maxProgresstime();
        ...
        this.mHeatCapacity = ((GT_MetaTileEntity_BlastFurnace)this.mTileEntity.mMetaTileEntity).mHeatCapacity;
        for (ICrafting var1 : (List<ICrafting>) this.crafters) {
            ...
            var1.sendProgressBarUpdate((Container)this, 104, this.mHeatCapacity);
        }
    }
