    ...
    public ItemStack slotClick(int aSlotIndex, int aMouseclick, int aShifthold, EntityPlayer aPlayer) {
	    ...
	    if (tSlot != null) {
		    ...
		    if (aSlotIndex < 9) {
		    	...
		    	((GT_MetaTileEntity_Translocator)mTileEntity.mMetaTileEntity).bOutput = !((GT_MetaTileEntity_Translocator)mTileEntity.mMetaTileEntity).bOutput;
			    if (aPlayer instanceof EntityPlayerMP)
			    	if (((GT_MetaTileEntity_Translocator)mTileEntity.mMetaTileEntity).bOutput)
		    	...
		    	((GT_MetaTileEntity_Translocator)mTileEntity.mMetaTileEntity).bInvertFilter = !((GT_MetaTileEntity_Translocator)mTileEntity.mMetaTileEntity).bInvertFilter;
			    if (aPlayer instanceof EntityPlayerMP)
			    	if (((GT_MetaTileEntity_Translocator)mTileEntity.mMetaTileEntity).bInvertFilter)
