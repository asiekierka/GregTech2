...
public class GT_Container_VacuumFreezer
extends GT_ContainerMetaTile_Machine {
    ...
    public GT_Container_VacuumFreezer(InventoryPlayer aInventoryPlayer, BaseMetaTileEntity aTileEntity, int aID) {
        super(aInventoryPlayer, aTileEntity, aID);
    }

    @Override
    public void addSlots(InventoryPlayer aInventoryPlayer) {
        this.addSlotToContainer(new Slot((IInventory)this.mTileEntity, 0, 34, 25));
        this.addSlotToContainer(new GT_Slot_Output((IInventory)this.mTileEntity, 1, 86, 25));
    }
    ...
    public void detectAndSendChanges() {
        ...
        this.mMachine = ((GT_MetaTileEntity_VacuumFreezer)this.mTileEntity.mMetaTileEntity).mMachine;
        this.mProgress = ((GT_MetaTileEntity_VacuumFreezer)this.mTileEntity.mMetaTileEntity).getProgresstime();
        this.mMaxProgress = ((GT_MetaTileEntity_VacuumFreezer)this.mTileEntity.mMetaTileEntity).maxProgresstime();
