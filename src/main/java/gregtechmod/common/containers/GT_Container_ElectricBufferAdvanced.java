...
public class GT_Container_ElectricBufferAdvanced
extends GT_ContainerMetaTile_Machine {
    ...
    public void addSlots(InventoryPlayer aInventoryPlayer) {
        ...
        this.addSlotToContainer(new GT_Slot_Holo((IInventory)this.mTileEntity, 1, 80, 63, false, true, 1));
    ...
    public ItemStack slotClick(int aSlotIndex, int aMouseclick, int aShifthold, EntityPlayer aPlayer) {
        ...
        if (tSlot != null) {
            ...
            if (aSlotIndex == 4) {
                ((GT_MetaTileEntity_ElectricBufferAdvanced)this.mTileEntity.mMetaTileEntity).mTargetSlot = Math.max(0, ((GT_MetaTileEntity_ElectricBufferAdvanced)this.mTileEntity.mMetaTileEntity).mTargetSlot - (aShifthold == 1 ? 16 : 1));
                return null;
            }
            if (aSlotIndex == 5) {
                ((GT_MetaTileEntity_ElectricBufferAdvanced)this.mTileEntity.mMetaTileEntity).mTargetSlot = Math.min(8192, ((GT_MetaTileEntity_ElectricBufferAdvanced)this.mTileEntity.mMetaTileEntity).mTargetSlot + (aShifthold == 1 ? 16 : 1));
                return null;
            }
        }
        return super.slotClick(aSlotIndex, aMouseclick, aShifthold, aPlayer);
    ...
    public void detectAndSendChanges() {
        ...
        this.mTargetSlot = ((GT_MetaTileEntity_ElectricBufferAdvanced)this.mTileEntity.mMetaTileEntity).mTargetSlot;
        for (ICrafting var1 : (List<ICrafting>) this.crafters) {
            var1.sendProgressBarUpdate((Container)this, 100, this.mTargetSlot);
        }
    }
