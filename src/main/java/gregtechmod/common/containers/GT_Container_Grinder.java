...
public class GT_Container_Grinder
extends GT_ContainerMetaTile_Machine {
    ...
    public void addSlots(InventoryPlayer aInventoryPlayer) {
        ...
        this.addSlotToContainer(new GT_Slot_Output((IInventory)this.mTileEntity, 5, 140, 25));
    }
    ...
    public void detectAndSendChanges() {
        ...
        this.mMachine = ((GT_MetaTileEntity_Grinder)this.mTileEntity.mMetaTileEntity).mMachine;
        this.mWaterAmount = ((GT_MetaTileEntity_Grinder)this.mTileEntity.mMetaTileEntity).mWaterAmount;
        this.mProgress = ((GT_MetaTileEntity_Grinder)this.mTileEntity.mMetaTileEntity).getProgresstime();
        this.mMaxProgress = ((GT_MetaTileEntity_Grinder)this.mTileEntity.mMetaTileEntity).maxProgresstime();
