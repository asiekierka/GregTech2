...
public class GT_MetaTileEntity_Centrifuge
extends MetaTileEntity {
    ...
    public void onRightclick(EntityPlayer aPlayer) {
        this.mBaseMetaTileEntity.openGUI(aPlayer, 146);
    }
    ...
    public void onPostTick() {
        if (this.mBaseMetaTileEntity.isServerSide()) {
            if (this.mStoredLava >= 1000 && (this.mInventory[6] == null || this.mInventory[6].stackSize < 64)) {
                if (this.mInventory[6] == null) {
                    this.mInventory[6] = new ItemStack(Block.lavaStill, 0);
                }
                this.mStoredLava -= 1000;
    ...
    private boolean spaceForOutput(int aRecipe) {
        return (this.mInventory[2] == null || ((GT_Recipe)GT_Recipe.sCentrifugeRecipes.get((int)aRecipe)).mOutput1 == null || this.mInventory[2].stackSize + ((GT_Recipe)GT_Recipe.sCentrifugeRecipes.get((int)aRecipe)).mOutput1.stackSize <= this.mInventory[2].getMaxStackSize() && this.mInventory[2].isItemEqual(((GT_Recipe)GT_Recipe.sCentrifugeRecipes.get((int)aRecipe)).mOutput1)) && (this.mInventory[3] == null || ((GT_Recipe)GT_Recipe.sCentrifugeRecipes.get((int)aRecipe)).mOutput2 == null || this.mInventory[3].stackSize + ((GT_Recipe)GT_Recipe.sCentrifugeRecipes.get((int)aRecipe)).mOutput2.stackSize <= this.mInventory[3].getMaxStackSize() && this.mInventory[3].isItemEqual(((GT_Recipe)GT_Recipe.sCentrifugeRecipes.get((int)aRecipe)).mOutput2)) && (this.mInventory[4] == null || ((GT_Recipe)GT_Recipe.sCentrifugeRecipes.get((int)aRecipe)).mOutput3 == null || this.mInventory[4].stackSize + ((GT_Recipe)GT_Recipe.sCentrifugeRecipes.get((int)aRecipe)).mOutput3.stackSize <= this.mInventory[4].getMaxStackSize() && this.mInventory[4].isItemEqual(((GT_Recipe)GT_Recipe.sCentrifugeRecipes.get((int)aRecipe)).mOutput3)) && (this.mInventory[5] == null || ((GT_Recipe)GT_Recipe.sCentrifugeRecipes.get((int)aRecipe)).mOutput4 == null || this.mInventory[5].stackSize + ((GT_Recipe)GT_Recipe.sCentrifugeRecipes.get((int)aRecipe)).mOutput4.stackSize <= this.mInventory[5].getMaxStackSize() && this.mInventory[5].isItemEqual(((GT_Recipe)GT_Recipe.sCentrifugeRecipes.get((int)aRecipe)).mOutput4));
    }

    private boolean checkRecipe() {
        int tRecipe = GT_Recipe.findEqualCentrifugeRecipeIndex(this.mInventory[0], this.mInventory[1]);
        if (tRecipe != -1 && this.spaceForOutput(tRecipe) && GT_Recipe.isRecipeInputEqual(true, true, this.mInventory[0], this.mInventory[1], (GT_Recipe)GT_Recipe.sCentrifugeRecipes.get(tRecipe))) {
            ...
            this.mMaxProgresstime = ((GT_Recipe)GT_Recipe.sCentrifugeRecipes.get((int)tRecipe)).mDuration;
            this.mEUt = ((GT_Recipe)GT_Recipe.sCentrifugeRecipes.get((int)tRecipe)).mEUt;
            this.mOutputItem1 = ((GT_Recipe)GT_Recipe.sCentrifugeRecipes.get((int)tRecipe)).mOutput1 == null ? null : ((GT_Recipe)GT_Recipe.sCentrifugeRecipes.get((int)tRecipe)).mOutput1.copy();
            this.mOutputItem2 = ((GT_Recipe)GT_Recipe.sCentrifugeRecipes.get((int)tRecipe)).mOutput2 == null ? null : ((GT_Recipe)GT_Recipe.sCentrifugeRecipes.get((int)tRecipe)).mOutput2.copy();
            this.mOutputItem3 = ((GT_Recipe)GT_Recipe.sCentrifugeRecipes.get((int)tRecipe)).mOutput3 == null ? null : ((GT_Recipe)GT_Recipe.sCentrifugeRecipes.get((int)tRecipe)).mOutput3.copy();
            this.mOutputItem4 = ((GT_Recipe)GT_Recipe.sCentrifugeRecipes.get((int)tRecipe)).mOutput4 == null ? null : ((GT_Recipe)GT_Recipe.sCentrifugeRecipes.get((int)tRecipe)).mOutput4.copy();
            return true;
        }
        tRecipe = GT_Recipe.findEqualCentrifugeRecipeIndex(this.mInventory[6], this.mInventory[1]);
        if (tRecipe != -1 && this.spaceForOutput(tRecipe) && GT_Recipe.isRecipeInputEqual(true, true, this.mInventory[6], this.mInventory[1], (GT_Recipe)GT_Recipe.sCentrifugeRecipes.get(tRecipe))) {
    ...
    public int getTextureIndex(int aSide, int aFacing, boolean aActive, boolean aRedstone) {
        ...
        if (aSide == 1) {
            return aActive ? 41 : 43;
        }
        return aActive ? 25 : 27;
    }
    ...
    public int fill(LiquidStack resource, boolean doFill) {
        ...
        LiquidStack tLiquid = new LiquidStack(Block.lavaStill, this.mStoredLava);
        ...
        if (resource.amount <= space) {
            if (doFill && space > 0) {
                this.mStoredLava += resource.amount;
            }
            return resource.amount;
        }
        if (doFill && space > 0) {
            this.mStoredLava = this.getCapacity();
        }
        return space;
    }
    ...
    public LiquidStack getLiquid() {
        return new LiquidStack(Block.lavaStill, this.mStoredLava);
    }
