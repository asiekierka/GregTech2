...
public class GT_TileEntity_UUMAssembler extends GT_TileEntityMetaID_Machine implements IQuantumChest, ITankContainer {
	...
	@Override public int getStartInventorySide(ForgeDirection aSide) {if (aSide == ForgeDirection.UP || aSide == ForgeDirection.DOWN) return 0; return 32;}
	@Override public int getSizeInventorySide (ForgeDirection aSide) {if (aSide == ForgeDirection.UP || aSide == ForgeDirection.DOWN) return 2; return 20;}
