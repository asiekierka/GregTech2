...
extends GT_MetaTileEntity_BasicTank {
    ...
    public void onRightclick(EntityPlayer aPlayer) {
        aPlayer.openGui((Object)GT_Mod.instance, 114, this.mBaseMetaTileEntity.worldObj, this.mBaseMetaTileEntity.xCoord, this.mBaseMetaTileEntity.yCoord, this.mBaseMetaTileEntity.zCoord);
    }
    ...
    public void onPostTick() {
        ...
        if (!this.mBaseMetaTileEntity.worldObj.isRemote && this.mBaseMetaTileEntity.mTickTimer % 10L == 0L) {
            ...
            if (this.mInventory[0] != null) {
                ...
                } else if (this.mLiquid.itemID == 0 && LiquidContainerRegistry.isFilledContainer((ItemStack)this.mInventory[0]) && LiquidContainerRegistry.getLiquidForFilledItem((ItemStack)this.mInventory[0]).amount < this.getCapacity()) {
                    boolean temp = true;
                    if (this.mInventory[0].getItem().hasContainerItem()) {
                        ItemStack tContainer = this.mInventory[0].getItem().getContainerItemStack(this.mInventory[0]);
                        if (this.mInventory[1] == null) {
                ...
                } else if (LiquidContainerRegistry.isEmptyContainer((ItemStack)this.mInventory[0]) && (tOutput = LiquidContainerRegistry.fillLiquidContainer((LiquidStack)this.mLiquid, (ItemStack)this.mInventory[0])) != null && (this.mInventory[1] == null || tOutput.isItemEqual(this.mInventory[1]) && this.mInventory[1].stackSize < tOutput.getMaxStackSize())) {
                    tOutput.stackSize = 1;
