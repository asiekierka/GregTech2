...
public class GT_MetaTileEntity_AdvancedTranslocator extends MetaTileEntity {
	...
	public int mInputSide = 0, mOutputSide = 0;
	...
	@Override public void onRightclick(EntityPlayer aPlayer)		{aPlayer.openGui(GT_Mod.instance, 104, mBaseMetaTileEntity.worldObj, mBaseMetaTileEntity.xCoord, mBaseMetaTileEntity.yCoord, mBaseMetaTileEntity.zCoord);}
	...
	public void loadNBTData(NBTTagCompound aNBT) {
		...
		mInputSide	  = aNBT.getInteger("mInputSide");
		mOutputSide	  = aNBT.getInteger("mOutputSide");
	}
	
	public void onPostTick() {
		if (!mBaseMetaTileEntity.worldObj.isRemote && mBaseMetaTileEntity.getStored() >= 1800 && mBaseMetaTileEntity.mTickTimer%10 == 0) {
			...
			if (tTileEntity1 != null && tTileEntity2 != null) {
				if (tTileEntity1 instanceof IInventory && tTileEntity2 instanceof IInventory) {
					...
					mBaseMetaTileEntity.decreaseStoredEnergy(GT_Utility.moveOneItemStack((IInventory)tTileEntity1, (IInventory)tTileEntity2, ForgeDirection.getOrientation(mInputSide), ForgeDirection.getOrientation(mOutputSide), tList, 6, 4, 2, bInvertFilter)*((mInventory[0] == null && mInventory[1] == null && mInventory[2] == null && mInventory[3] == null && mInventory[4] == null && mInventory[5] == null && mInventory[6] == null && mInventory[7] == null && mInventory[8] == null)?1:2), true);
				}
			}
		}
	...
	public int getTextureIndex(int aSide, int aFacing) {
		...
		int tIndex = 129+(mBaseMetaTileEntity.mActive?8:0);
