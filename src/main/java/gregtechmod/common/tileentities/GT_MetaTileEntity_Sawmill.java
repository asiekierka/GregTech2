...
public class GT_MetaTileEntity_Sawmill
extends MetaTileEntity {
    ...
    public void onRightclick(EntityPlayer aPlayer) {
        aPlayer.openGui((Object)GT_Mod.instance, 116, this.mBaseMetaTileEntity.worldObj, this.mBaseMetaTileEntity.xCoord, this.mBaseMetaTileEntity.yCoord, this.mBaseMetaTileEntity.zCoord);
    }
        ...
        for (int i = -1; i < 2; ++i) {
            for (int j = 1; j < 2; ++j) {
                for (int k = -1; k < 2; ++k) {
                    ...
                    if (this.mBaseMetaTileEntity.worldObj.getBlockMetadata(this.mBaseMetaTileEntity.xCoord - xDir + i, this.mBaseMetaTileEntity.yCoord - yDir + j, this.mBaseMetaTileEntity.zCoord - zDir + k) == (i == 0 && k == 0 ? 14 : 13)) continue;
                    return false;
                }
            }
        }
    ...
    private boolean spaceForOutput(int aRecipe) {
        return (this.mInventory[2] == null || ((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)aRecipe)).mOutput1 == null || this.mInventory[2].stackSize + ((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)aRecipe)).mOutput1.stackSize <= this.mInventory[2].getMaxStackSize() && this.mInventory[2].isItemEqual(((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)aRecipe)).mOutput1)) && (this.mInventory[3] == null || ((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)aRecipe)).mOutput2 == null || this.mInventory[3].stackSize + ((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)aRecipe)).mOutput2.stackSize <= this.mInventory[3].getMaxStackSize() && this.mInventory[3].isItemEqual(((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)aRecipe)).mOutput2)) && (this.mInventory[4] == null || ((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)aRecipe)).mOutput3 == null || this.mInventory[4].stackSize + ((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)aRecipe)).mOutput3.stackSize <= this.mInventory[4].getMaxStackSize() && this.mInventory[4].isItemEqual(((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)aRecipe)).mOutput3)) && (this.mInventory[5] == null || ((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)aRecipe)).mOutput4 == null || this.mInventory[5].stackSize + ((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)aRecipe)).mOutput4.stackSize <= this.mInventory[5].getMaxStackSize() && this.mInventory[5].isItemEqual(((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)aRecipe)).mOutput4));
    }
    ...
    private boolean checkRecipe() {
        ...
        int tRecipe = GT_Recipe.findEqualSawmillRecipeIndex(this.mInventory[0], this.mInventory[1]);
        if (tRecipe != -1) {
            if (this.spaceForOutput(tRecipe) && GT_Recipe.isRecipeInputEqual(true, true, this.mInventory[0], this.mInventory[1], (GT_Recipe)GT_Recipe.sSawmillRecipes.get(tRecipe))) {
                ...
                this.mMaxProgresstime = ((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)tRecipe)).mDuration;
                this.mEUt = ((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)tRecipe)).mEUt;
                this.mOutputItem1 = ((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)tRecipe)).mOutput1 == null ? null : ((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)tRecipe)).mOutput1.copy();
                this.mOutputItem2 = ((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)tRecipe)).mOutput2 == null ? null : ((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)tRecipe)).mOutput2.copy();
                this.mOutputItem3 = ((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)tRecipe)).mOutput3 == null ? null : ((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)tRecipe)).mOutput3.copy();
                return true;
            }
        } else {
            ItemStack tWaterStack = this.mWaterAmount >= 1000 ? GT_ModHandler.getIC2Item("waterCell", this.mWaterAmount / 1000) : null;
            tRecipe = GT_Recipe.findEqualSawmillRecipeIndex(this.mInventory[0], tWaterStack);
            if (tRecipe != -1 && this.spaceForOutput(tRecipe) && GT_Recipe.isRecipeInputEqual(true, true, this.mInventory[0], tWaterStack, (GT_Recipe)GT_Recipe.sSawmillRecipes.get(tRecipe))) {
                if (this.mInventory[0] != null && this.mInventory[0].stackSize == 0) {
                    this.mInventory[0] = null;
                }
                ...
                this.mOutputItem1 = ((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)tRecipe)).mOutput1 == null ? null : ((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)tRecipe)).mOutput1.copy();
                this.mOutputItem2 = ((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)tRecipe)).mOutput2 == null ? null : ((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)tRecipe)).mOutput2.copy();
                if (((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)tRecipe)).mOutput3 == null) {
                    this.mOutputItem3 = null;
                } else if (!((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)tRecipe)).mOutput3.isItemEqual(GT_ModHandler.getIC2Item("cell", 1))) {
                    this.mOutputItem3 = ((GT_Recipe)GT_Recipe.sSawmillRecipes.get((int)tRecipe)).mOutput3.copy();
                }
                return true;
            }
        }
