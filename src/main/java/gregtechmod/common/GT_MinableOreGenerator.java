...
extends WorldGenerator {
    ...
    public GT_MinableOreGenerator(int id, int meta, int number, boolean aAllowVoid) {
        this(id, number);
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        double var7 = (float)(par3 + 8) + MathHelper.sin((float)var6) * (float)this.numberOfBlocks / 8.0f;
        double var9 = (float)(par3 + 8) - MathHelper.sin((float)var6) * (float)this.numberOfBlocks / 8.0f;
        double var11 = (float)(par5 + 8) + MathHelper.cos((float)var6) * (float)this.numberOfBlocks / 8.0f;
        double var13 = (float)(par5 + 8) - MathHelper.cos((float)var6) * (float)this.numberOfBlocks / 8.0f;
            ...
            for (int var38 = var32; var38 <= var35; ++var38) {
                ...
                for (int var41 = var33; var41 <= var36; ++var41) {
                    ...
                    for (int var44 = var34; var44 <= var37; ++var44) {
                        ...
                        if (!(var39 * var39 + var42 * var42 + var45 * var45 < 1.0) || (!this.allowVoid || par1World.getBlockId(var38, var41, var44) != 0) && (block == null || block.blockID != Block.netherrack.blockID && block.blockID != Block.whiteStone.blockID && !block.isGenMineableReplaceable(par1World, var38, var41, var44))) continue;
