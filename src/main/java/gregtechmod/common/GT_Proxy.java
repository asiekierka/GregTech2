...
public class GT_Proxy {
    public void initialize() {
        TickRegistry.registerTickHandler((ITickHandler)new GT_TickHandler(), (Side)Side.SERVER);
        GameRegistry.registerFuelHandler((IFuelHandler)new GT_FuelHandler());
        GameRegistry.registerWorldGenerator((IWorldGenerator)new GT_Worldgenerator());
        this.addSounds();
    }
    ...
    public void addSounds() {
        ...
        GT_Mod.mSoundItems.add(new ItemStack((Block)Block.fire, 1));
        ...
        GT_Mod.mSoundCounts.add(1);
        GT_Mod.mSoundItems.add(new ItemStack((Block)Block.portal, 1));
        ...
        GT_Mod.mSoundCounts.add(1);
        GT_Mod.mSoundItems.add(new ItemStack((Item)Item.potion, 1));
        ...
        GT_Mod.mSoundCounts.add(1);
        GT_Mod.mSoundItems.add(new ItemStack((Block)Block.grass, 1));
